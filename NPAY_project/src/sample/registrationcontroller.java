...
public class registrationcontroller implements Initializable{
    ...
    public void registerbuttonaction(ActionEvent actionEvent) {
        if(checkanomalies()){
            ...
            String order=username.getText();
            order=order.replaceAll("[^a-zA-Z0-9]","");
            String insertquery="INSERT INTO login(username,pasword,firstname,lastname,hostelname,phone) values('"+u_Name+"','"+pass+"','"+firstName+"','"+lastName+"','"+h_Name+"','"+p_number+"')";
            String order_table="CREATE TABLE "+order+"_order(product varchar(100),quantity int,price int,cafe varchar(50))";
            String trans_table="create table "+order+"_trans(id int unique auto_increment,product varchar(50),cafe varchar(50),price int,quantity int,o_status varchar(50))";
            ...
            try{
                ...
                statement.executeUpdate(order_table);
                statement.executeUpdate(trans_table);
            }catch (Exception e){
                e.printStackTrace();
                e.getCause();
            }
