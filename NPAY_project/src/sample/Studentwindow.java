...
public class Studentwindow implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        String verifylogIn = "SELECT * FROM login WHERE username='"+userinformation.getname()+"'AND pasword='"+userinformation.getPassword()+"'";;
        try{
            ...
            while (resultSet.next()){
                ...
                hostelnameid.setText(resultSet.getString("hostelname"));
                balanceid.setText(resultSet.getString("wallet"));
                userinformation.setWallet(Integer.parseInt(resultSet.getString("wallet")));
                userinformation.setU_name(resultSet.getString("firstname"));
                userinformation.setHostel(resultSet.getString("hostelname"));
